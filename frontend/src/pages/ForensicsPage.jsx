...
import { VersionSlider } from '../components/Forensics/VersionSlider';
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight">Time-Travel Forensics</h1>
        <p className="text-gray-500">Drift Viewer for finding suspicious codebase insertions across package versions.</p>
      </div>
      ...
      <div className="flex-1 min-h-[600px] border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
        {activePackage && <VersionSlider pkgName={activePackage} />}
      </div>
    </div>
  );
}
